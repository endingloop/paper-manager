...
<body>
	<div class="container">
		<header> <a href="index.jsp" id="index">论文管理器</a> <a
			href="<s:url action="Logout" />" id="right">注销</a> <a
			href="<s:url action='addend' />" id="left"><s:property
				value="getUsername()" /></a> </header>
		<hr />
		<div  style="align: center; margin-left: 5%; margin-right: 5%;">
		<div id="content2_top">
			<ul class="nav nav-tabs nav-justified">
				<li role="presentation" class="active"><a href="<s:url action="Login"/>">我的论文</a></li>
